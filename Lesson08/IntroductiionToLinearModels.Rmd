...
$$y = A \vec{b} + \vec{\epsilon}$$

- $y$ is the vector of $n$ dependent variables or labels we seek to predict   
...
- The residuals must be **homoskedastic** with respect to the fitted values    
    - Homosedastic residuals have constant variance with predicted values    
