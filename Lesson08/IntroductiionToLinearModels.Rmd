...
- Model coefficients provide information on response sensitivities to changes in variables    
   - Poor human intuition about complex and nonlinear models    
   - Less chance of *unexpected output**   
...
- We can find the minimum of this linear system with an efficient solver   
   ...
   - Qusi-Newton methods like **L-BFGS**
...
```{r AlphaTrimming, out.width = '25%', fig.cap='Influence functions for mean and median', fig.align='center', echo=FALSE}
