...
- Key idea: D+-isplay a scatter plots of each variable versus all other variables    
   - Primarily EDA tool    
...
- Facet plots extend the number of dimensions projeted onto 2-d plot surface 
