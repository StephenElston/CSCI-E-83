...
- Example: Intensity of an arrival process, $poisson(\lambda)$ response   
   - $\lambda$ is the averate rate or **intensity** of a point process 
...
Link functions are avaialble for many distributions      
...
How can we understand the cuttoff value in terms of the CDF of the positive and negative cases?    
...
- Positive cases to the left of cuttoff are Type II errors     
- Negative cases to the right of cutoff are Type I errors   
...
- The generalized linear model accomodates nonlinear response distributions          
...
- Evaluating Binomial response models    
   ...
   - Compute metrics from elements of confsion matrix
