...
Procedure Prior(sampling_values, prior_parameter_value):    
    return likelihood_function(sampling_value, prior_parameter_values)    
...
A confidence interval is a purely frequentest concept   
   - Is an interval on the **sampling distribution** where repeated samples of a statistic are expected with probability $= 1-\alpha$     
...
Credible interval is an interval on a posterior distribution of the statistic    
   ...
   - Credible interval is the interval with highest $1-\alpha$ probability for the statistic being estimated       
