...
- Any statistic we compute for the generating process is an approximation for the polulation, $s(\hat{\mathcal{F}})$  

```{r Sampling, out.width = '60%', fig.cap='Sampling distribution of unknown population paraeter', fig.align='center', echo=FALSE}
...
- **Utility nodes**, profit in this case, are shown as diamonds    
  - Nodes represent a **utility function** given the dependencies in the graphe   
