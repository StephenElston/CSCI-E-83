...
- This week and next, statitical inference, hypothesis testing, bootstrap resampling    
...
- Sources of uncertainty    
  - Epistemic; arrises from the population       
  - Statistical; arrises from sampling      
...
- A **statistic** is an estimate of a parameter of the **population distribution**   
  - The distribution of the statistc is the **sampling distribution**   
...
|:----------------------- | :----------------- |
| How certain are you that eating a fad food improves your health? | Some of my friends are doing great on this diet |   
...
| What is the risk inherent in a certain stock trading strategy actually improve returns? | Traders using this strategy have made money recently | 
...
**Inference for prediction:** In recent decades the distinction between prediction and clasical inference has blurred to the point of being irrelevant     
...
- The **cummulative distribution function (CDF)** of a standard Normal distribution, $N(0,1)$  
