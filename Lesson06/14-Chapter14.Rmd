...
> **Exercise 14-2:** As has been discussed, the one sample bootstrap algorithm can be applied to most any suitable statistic. Compute the bootstrap point estiamte of the meadian of the agregate math scores from the SBS2 dataset. Display the histogram and Q-Q plots of the bootstrap distribution. Notice the deviations from the Normal distribution of this statistic. Why do you think this should be the case?   

## Bootstrap Confidence Intervals   

Now that we can compute a bootstrap distribution the net step is to find the confidence intervals. The direct approach is to use the **percentile method**. In simple terms, the ......................
