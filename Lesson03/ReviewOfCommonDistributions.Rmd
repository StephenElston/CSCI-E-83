---
title: "Review of Common Probability Distributions"
author: "Steve Elston"
date: "01/13/2021"
output:
...
1. On the an interval, $\{ x_1, x_2 \}$, $P(x)$, must be bounded by 0 and 1:
...
- For a single trial the probabilities of the $k$ possible:    
...
Gamma family can be parameterized in several ways; we will use a  with a shape parameter, $\nu$ and a scale parameter $\sigma$.    
