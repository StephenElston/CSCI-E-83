...
- Required to normalize the posterior distribution to range $0 \le Posterior(hypotheis\ |\ evidence) \le 1$  
...
- Sickle Cell Anemia is a serious, but fairy rare disease    
...
From the root the **directed acyclical graphical model (DAG)** defines a conditional dependency structure
