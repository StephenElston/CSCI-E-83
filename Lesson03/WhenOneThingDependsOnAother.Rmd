...
- What is the likelihood for the two sons $X = (x_1,x_2)$ not having hemopilia?   
...
Use Bayes theorem to compute probability woman carries X chromosome with hemophilia expression, $\theta = 1$
...
The evidence of two sons without hemophilia causes us to update our **belief** that the probability of the woman carring the   
