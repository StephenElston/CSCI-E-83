...
- Must find good temperature value of $T$ to **tune** the algorithm    
  * $T$ too small, search is only local    
  * $T$ too large, search makes large jumps   
   
- Hard to find good hyperparameter values, L and $T$, in practice      
...
- NUTS improves on HMC     
  ...
  * Equilibrium point determines $T$ automatically  
  * Eliminates tuning    
