...
- **Computer intensive resampling methods** for building models and inference    
  - Bootstrapping 
  - MCMC Bayes   
...
- **Sparse models** for complex high-dimensional data 
...
- Can be great addition to your data science pr0ject portfolio   
...
- Class meeting Thursdays, 5:30 pm US Eastern Time:    
  - Focus on theory to understand concepts   
  - Limited time for code discussions   

- Section meetings on Mondays, 5:30 pm US Eastern Time:    
...
**Ed is the primary communications method**    
  - Generally use public posts - okay to include code snipits   
...
- Ideally want strait line relationship  
  - Nonlinear relationships often arrise from non-Normal distributions  
