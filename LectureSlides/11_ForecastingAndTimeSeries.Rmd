...
Many types of time series models; we only consider a few       

- **Time series decomposition** into components   
   * **STL** or [**seasonal-trend decomposition with LOESS**](https://www.statsmodels.org/dev/examples/notebooks/generated/stl_decomposition.html)      
   * **MSTL** or [**multiple seasonal-trend decomposition with LOESS**](https://www.statsmodels.org/dev/examples/notebooks/generated/mstl_decomposition.html)   
- **Exponential models**    
   * Beyond the scope of our course   
   * See [Chapter 8](https://otexts.com/fpp3/expsmooth.html) of Forecasting: Principles and Practice, Hyndman and Athanasopoulos, third edition, O Texts, 2021, for a in-depth discussion         
- **ARIMA**: autoregressive integrative moving average     
  * **AR** or **autoregressive component** accounts for serial correlation of values      
  * **I** or **integrative component** component accounts for random walk and trend components     
  * **MA** or **moving average component** accounts for serial correlation of errors  
...
- Difference operator with $\delta = n$ computes a series $n$ shorter than original     
...
- The AR model is unstable for the roots of the polynomial $1 - \phi^2$   
- To be a stable AR process, $\phi^2 \lt 1$    
...
- Fourier decomposition    
    - Flexible and accomodates multiple periods of seasonality    
...
- Additive model can be expressed: $SARIMA \big[ (p,d,q) + (P,D,Q)_M \big]$    

- Multiplicative model can be expressed: $SARIMA \big[ (p,d,q)(P,D,Q)_M \big]$   

- Example, a multiplicative $SARIMA(1,1,1)(1,1,1)_M$ model:   

$$(y_t - \phi_1 y_{t-1})(y_t - \Phi_1 y_{t-M})(1-y_{t-1})(y_t - y_{t-M}) = (\epsilon_t - \theta_1 \epsilon_{t-1})(\epsilon_t - \Theta_1 \epsilon_{t-M})$$    

- Continuesame algebra to find the polynomial of any $(p,d,q)(P,D,Q)$ order    

- Create a recurssion to forecast future values as shown before       
