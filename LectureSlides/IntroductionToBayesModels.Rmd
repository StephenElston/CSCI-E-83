...
- Sum over $𝑃( 𝑑𝑎𝑡𝑎 | 𝑝𝑎𝑟𝑎𝑚𝑒𝑡𝑒𝑟𝑠 )𝑃( 𝑝𝑎𝑟𝑎𝑚𝑒𝑡𝑒𝑟𝑠 )$ to find the marginal distribution $P(B)$     
...
- General guidance is that a prior must be convincing to a **skeptical audience**, often vague in practice       
...
Normal - mean| Normal
Normal - variance | Inverse Gamma, $\chi^2$
