...
- Say a woman has a brother who exhibits hemophilia   
  - X chromosome expression is $\theta = 1.0$  - brother has hemophilia with $P = 1.0$
  - Woman's father does not exhibit hemophilia, $\theta = 0$ - father has hemophilia with $P = 0.0$  
...
**Marginal distributions** of multivariate Normal with $\mu = [0,0]$ and $\sigma = \begin{bmatrix} 1.0 & 0.0 \\ 0.0 & 0.5 \end{bmatrix}$
