...
- Is the distribution of the differences between observed and predicted responses zero centered?      

- **Bayesian p-value** is a statistic for the distribution differences between observed and predicted responses        
   * Want probability of positive difference equal to the probability of negative difference       
   * Bayesian p-value $= 0.5$ is 
...
- Average preditive is heavier in the tails    
...
```{r BayesianPValue, out.width = '60%', fig.cap='Distribution of ..........................', echo=FALSE}
knitr::include_graphics(rep("../images/BayesianPValue.png"))
```

- Plot is centered on 0.5     

- Distibution of ...... looks promisng    
...
```{r LocalPValue, out.width = '60%', fig.cap='Distribution of ..........................', echo=FALSE}
knitr::include_graphics(rep("../images/LocalPValue.png"))
```

- The values are close to 1.0 across all values of the ....................
