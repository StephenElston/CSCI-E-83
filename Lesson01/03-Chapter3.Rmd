...
> **Exercise 3-1:** Create the code to create a frequency table of body style and then number of doors. What does this table tell you about which types of cars are the most and least popular?  
