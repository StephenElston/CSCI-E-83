...
> **Exercise:** In the previous exercise, you used bgatch gradient descent to estimate the parameters of the distributio of the log housing prices. Now, you will use SGD to estimate these parameters. Using a Bernoulli mini=batch sample size of 100 log housing price values, follow these steps:   
